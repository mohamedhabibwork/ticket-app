...
function getEncryptionKey(): Buffer {
  const secret = process.env.ENCRYPTION_SECRET || process.env.DATABASE_URL || "default-secret-change-me";
...
export function verifyStateToken(token: string, stored: string, maxAgeMs: number = 600000): boolean {
