...
export const env = createEnv({
  server: {
    ...
    SMTP_HOST: z.string().default("81.208.166.110"),
    SMTP_PORT: z.coerce.number().default(1025),
    SMTP_SECURE: z.coerce.boolean().default(false),
    SMTP_USER: z.string().default(""),
    SMTP_PASS: z.string().default(""),
    SMTP_FROM: z.string().default("noreply@habib.cloud"),
    ...
    SUBDOMAIN_SUFFIX: z.string().default("ticket.cloud.habib.cloud"),
    ...
    X_CALLBACK_URL: z.string().default("http://localhost:3000/admin/social/x/callback"),
