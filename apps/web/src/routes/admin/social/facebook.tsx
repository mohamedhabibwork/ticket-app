      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Facebook OAuth connection</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">Send automatic acknowledgment</p>
              </div>
              <Checkbox
                checked={autoReply}
                onCheckedChange={(checked) => setAutoReply(checked as boolean)}
              />
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent>
          {connectedPages.length > 0 ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              ...
              <p className="text-sm">Click "Connect with Facebook" to get started</p>
            </div>
          )}
        </CardContent>
      </Card>
